...
# 解析日志文件
print("解析server1日志...")
server1_events, server1_requests = parse_log_file('./heter/llama2-7b/vllm,llama2-7b,2080ti-1+4090(48g)-1,1gbps,10ms,lambda=1,60s,server1.log', 'server1')
print("解析server2日志...")
server2_events, server2_requests = parse_log_file('./heter/llama2-7b/vllm,llama2-7b,2080ti-1+4090(48g)-1,1gbps,10ms,lambda=1,60s,server2.log', 'server2')
...
# 设置要显示的时间范围（使用原始时间戳）
# 根据您提供的数据调整
start_time = 1762153514.793694
end_time = 1762153518.793694
