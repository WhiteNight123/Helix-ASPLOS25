# 2024.10.27 Helper functions for Qwen3-32B

from typing import Dict, Tuple
from simulator.event_simulator.utils import Qwen3_32B_TOTAL_LAYERS, AVG_INPUT_LEN, AVG_OUTPUT_LEN, KV_CACHE_HWM


def qwen32b_workload_ratio(target_machine_name: str, target_num_layers: int,
    ...
    round_trip_time = (Qwen3_32B_TOTAL_LAYERS - target_num_layers) * (sum_of_time / sum_of_layers)
...
def qwen32b_typical_statistics(workload_ratio: float, num_kv_cache_entries: int,
