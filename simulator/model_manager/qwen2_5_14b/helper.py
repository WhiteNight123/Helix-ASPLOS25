# 2024.10.23 Helper functions for Qwen2.5-14B

from typing import Dict, Tuple
from simulator.event_simulator.utils import Qwen2_5_14B_TOTAL_LAYERS, AVG_INPUT_LEN, AVG_OUTPUT_LEN, KV_CACHE_HWM


def qwen14b_workload_ratio(target_machine_name: str, target_num_layers: int,
    ...
    round_trip_time = (Qwen2_5_14B_TOTAL_LAYERS - target_num_layers) * (sum_of_time / sum_of_layers)
