# 2024.11.02 Helper functions for LLaMa2-13B

from typing import Dict, Tuple
from simulator.event_simulator.utils import LLaMa2_13B_TOTAL_LAYERS, AVG_INPUT_LEN, AVG_OUTPUT_LEN, KV_CACHE_HWM


def llama13b_workload_ratio(target_machine_name: str, target_num_layers: int,
    ...
    round_trip_time = (LLaMa2_13B_TOTAL_LAYERS - target_num_layers) * (sum_of_time / sum_of_layers)
...
def llama13b_typical_statistics(workload_ratio: float, num_kv_cache_entries: int,
